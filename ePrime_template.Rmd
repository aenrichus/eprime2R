...
# read the txt file from ePrime
# IMPORTANT: output for Statview/SPSS, no Unicode
...
colnames(data) <- c("A1", "id", "B1", "B2", "B3", "B4", "B5", "date", "C1", "C2", "C3", "C4", "C5", "balancing", "D1", "D2", "practice", "E1", "E2", "E3", "E4", "E5", "E6", "E7", "E8", "baseword", "F1", "F2", "F3", "lexicality", "G1", "G2", "G3", "G4", "G5", "stimset", "H1", "H2", "trialorderA", "I1", "I2", "trialorderB", "stimtype", "stimulus", "J1", "J2", "J3", "J4", "accuracy", "K1", "K2", "RT", "L1", "L2")

# select the columns that are important
data <- select(data, id, balancing, practice, baseword, lexicality, stimset, trialorderA, trialorderB, stimtype, stimulus, accuracy, RT)
...
data <- select(data, id, balancing, trialorder, lexicality, baseword, set = stimset, type = stimtype, stim = stimulus, acc = accuracy, err = error, prt = prevRT, rt = RT.hit)
...
# select the important columns
data <- select(data, id, balancing, trialorder, lexicality, baseword, type, stim, err, prt = prt.winsor, rt = rt.winsor)
